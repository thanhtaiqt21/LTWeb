                    ...
                    <div class="related-posts__list">
                      ...
                      >
                        <div class="post-card__image">
                          <a href="blogDetail?bid=${blog.id}"
                            ><img src="${blog.imgUrl}" alt=""
                          /></a>
                        </div>
                        <div class="post-card__info">
                          <div class="post-card__name">
                            <a href="blogDetail?bid=${blog.id}">${blog.title}</a>
                          </div>
                          <div class="post-card__date">${blog.timestamp}</div>
                        </div>
                      </div>
                      </c:forEach>
