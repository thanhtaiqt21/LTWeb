...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Thêm slide mới | Nalika - Material Admin Template</title>
                ...
                <div class="review-tab-pro-inner">
                  ...
                  >
                    <div
                      ...
                      id="description"
                    >
                      <form action="/ecommerce/adminpage/img-slide-add" method="post" enctype="multipart/form-data" id="form-add-slide">
                      <div class="row">
                          ...
                          <div class="review-content-section">
                            <div class="input-group mg-b-pro-edt">
                              <span class="input-group-addon"
                                ...
                                <input class="form-control" type="file" id="formFileMultiple" name="imgs" multiple>
                            </div>
                          </div>
                        </div>
                      </div>
