...
<div class="site">
    ...
    <div class="verify-email-wrapper" style="margin-bottom: 0px">
        <h5>Đã gửi mật khẩu mới vào email của bạn</h5>
    </div>
    <div class="verify-email-wrapper" style="margin-top: 0px"><a href="login.jsp">Quay lại trang đăng nhập</a></div>
    <!-- site__footer -->
